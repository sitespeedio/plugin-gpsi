  ...
  if (psiResult.loadingExperience.metrics) {
    ...
    if (
      ...
      result.loadingExperience.INTERACTION_TO_NEXT_PAINT = {
        percentile:
          psiResult.loadingExperience.metrics
            .INTERACTION_TO_NEXT_PAINT.percentile,
        fast:
          psiResult.loadingExperience.metrics
            .INTERACTION_TO_NEXT_PAINT.distributions[0].proportion,
        moderate:
          psiResult.loadingExperience.metrics
            .INTERACTION_TO_NEXT_PAINT.distributions[1].proportion,
        slow:
          psiResult.loadingExperience.metrics
            .INTERACTION_TO_NEXT_PAINT.distributions[2].proportion
      };
    }
