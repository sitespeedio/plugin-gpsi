...
module.exports = {
  repackage(psiResult) {
    ...
    const result = {
      ...
      googleWebVitals: {
        firstContentfulPaint: psiResult.lighthouseResult.audits['first-contentful-paint'].numericValue,
        largestContentfulPaint:psiResult.lighthouseResult.audits['largest-contentful-paint'].numericValue,
        totalBlockingTime: psiResult.lighthouseResult.audits['total-blocking-time'].numericValue,
        cumulativeLayoutShift: psiResult.lighthouseResult.audits['cumulative-layout-shift'].numericValue
      },
      data: psiResult
    };
